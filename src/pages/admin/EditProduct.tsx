...
export function EditProduct() {
  ...
  useEffect(() => {
    if (product) {
      ...
      setSpecifications(typeof product.specifications === 'string' ? product.specifications : '')
      setImageUrl(product.image_url || '')
      setStockQuantity(product.stock_quantity || 1)
      setAvailableQuantity(product.available_quantity || 1)
      setDailyRate(product.daily_rate || 0)
      setWeeklyRate(product.weekly_rate || 0)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : t('products.edit.updateError'))
    }
  }
